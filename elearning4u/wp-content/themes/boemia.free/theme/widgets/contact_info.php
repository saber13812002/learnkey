...
class contact_info extends WP_Widget
{
	...
	function widget( $args, $instance )
	{
		...
		$text .= '  <ul>';
            $text .= ( !empty( $instance['address'] ) ) ? '<li>' . $address_image . '<span>' . __( 'Location', 'yit' ) . ':</span> ' . do_shortcode( $instance['address'] ) . '</li>' : '';
            $text .= ( !empty( $instance['phone'] ) ) ? '<li>' . $phone_image  . '<span>' . __( 'Phone', 'yit' ) . ':</span> ' . do_shortcode( $instance['phone'] ) . '</li>' : '';
            $text .= ( !empty( $instance['mobile'] ) ) ? '<li>' . $mobile_image  . '<span>' . __( 'Mobile', 'yit' ) . ':</span> ' . do_shortcode( $instance['mobile'] ) . '</li>' : '';
            $text .= ( !empty( $instance['fax'] ) ) ? '<li>' . $fax_image  . '<span>' . __( 'Fax', 'yit' ) . ':</span> ' . do_shortcode( $instance['fax'] ) . '</li>' : '';
            $text .= ( !empty( $instance['email'] ) ) ? '<li>' . $email_image  . '<span>' . __( 'Email', 'yit' ) . ':</span> ' . do_shortcode( $instance['email'] ) . '</li>' : '';
		$text .= '  </ul>';
		$text .= '</div>'; 
