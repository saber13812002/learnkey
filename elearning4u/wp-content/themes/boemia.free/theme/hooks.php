...
add_action( 'yit_before_header', 'yit_topbar', 5 );
...
add_action( 'yit_enqueue_blog_stuffs', create_function( '', 'yit_enqueue_style( 100, "blog-big", get_template_directory_uri() . "/theme/templates/blog/big/css/style.css" );' ) );
add_action( 'yit_enqueue_blog_stuffs', create_function( '', 'yit_enqueue_style( 100, "blog-small", get_template_directory_uri() . "/theme/templates/blog/small/css/style.css" );' ) );
add_action( 'yit_enqueue_blog_stuffs', create_function( '', 'yit_enqueue_style( 100, "blog-elegant", get_template_directory_uri() . "/theme/templates/blog/elegant/css/style.css" );' ) );
add_action( 'yit_enqueue_blog_stuffs', create_function( '', 'yit_enqueue_style( 100, "blog-pinterest", get_template_directory_uri() . "/theme/templates/blog/pinterest/css/style.css" );' ) );
