...
$show_title      = is_page($post_id) ? yit_get_post_meta( $post_id, '_show-title' ) : false;
$show_breadcrumb = is_page($post_id) ? yit_get_post_meta( $post_id, '_show-breadcrumb' ) : ( bool ) yit_get_option('breadcrumb');
