...
<?php endif; ?>
			...
			<header class="title">
				...
				<a href="<?php echo esc_url( wc_get_endpoint_url( 'edit-address', 'billing' ) ); ?>" class="edit"><?php _e('Edit', 'yit'); ?></a>
			</header>
			<address>
				<?php
					$address = array(
...
<?php if (get_option('woocommerce_ship_to_billing_address_only')=='no') : ?>
		...
		<div class="col-2">
			...
			<header class="title">
				...
				<a href="<?php echo esc_url( wc_get_endpoint_url( 'edit-address', 'shipping' ) ); ?>" class="edit"><?php _e('Edit', 'yit'); ?></a>
			</header>
			<address>
				<?php
					$address = array(
